...
## 从逆序生成排列算法  
算法如下：  
![](https://cdn.jsdelivr.net/gh/JingqingLin/ImageHosting/img/20200206112339.png)
...
- ⭐转化为[**最大连续子数组（diff数组）求和**](https://leetcode-cn.com/problems/maximum-subarray/solution/zui-da-zi-xu-he-by-leetcode/)问题。  
