...
# ⭐153. 寻找旋转排序数组中的最小值
### [153 无重复元素](https://leetcode-cn.com/problems/find-minimum-in-rotated-sorted-array/)
...
### [154 有重复元素](https://leetcode-cn.com/problems/find-minimum-in-rotated-sorted-array-ii/)
需要单独考虑 `nums[m] == nums[r]` 相等的情况，考虑用例：`[10, 18, 10, 10, 10, 10]` 和 `[10, 1, 10, 10, 10, 10]`

### [33 搜索给定值](https://leetcode-cn.com/problems/search-in-rotated-sorted-array/)
